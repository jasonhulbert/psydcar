# Psydcar POC — Implementation Spec

## 1. Overview

Build a local-first psydcar system that allows an agent to search and read from one or more indexed local directories (sidecars).
...
psydcar mcp --sidecars frontend,backend
